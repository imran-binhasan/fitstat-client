...
const {loading,setLoading} = useAuth();
  ...
  const {error, paymentIntent} = await stripe.confirmCardPayment(bookingData.clientSecret,{payment_method:{
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
     <p><strong>Trainer Name:</strong> {bookingData?.trainerName}</p>
      <p><strong>Slot Name:</strong> {bookingData?.slotName}</p>
      <p><strong>Package Name:</strong> {bookingData?.packageName}</p>
      <p><strong>Price:</strong> ${bookingData?.packagePrice}</p>
