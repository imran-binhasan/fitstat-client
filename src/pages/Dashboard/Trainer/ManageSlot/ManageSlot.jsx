          ...
          <table className="w-full bg-white border border-gray-200 shadow-lg rounded-lg overflow-hidden">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="py-3 px-2 sm:px-4 text-left font-semibold text-gray-700">DAY</th>
                <th className="py-3 px-2 sm:px-4 text-left font-semibold text-gray-700">NAME</th>
                <th className="py-3 px-2 sm:px-4 text-left font-semibold text-gray-700">DURATION</th>
                <th className="py-3 px-2 sm:px-4 text-left font-semibold text-gray-700">CLASS</th>
                <th className="py-3 px-2 sm:px-4 text-left font-semibold text-gray-700">ACTION</th>
              </tr>
            </thead>
            <tbody>
              {slots.map((slot) => (
